...
foreach ($seats as $seat) {
    echo '<span class="seat-pill">'.$seat.'</span>';
}
?>
                    ...
                    <div class="card booking-card h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <span class="status-badge 
                                <?= $booking['payment_status'] == 'paid' ? 'bg-success text-white' : 
                                   ($booking['payment_status'] == 'refunded' ? 'bg-secondary text-white' : 'bg-warning text-dark') ?>">
                        ...
                        <div class="card-footer bg-transparent d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <?php elseif ($booking['payment_status'] == 'paid' && !$is_past): ?>
                                    <?php if ($hours_diff > 6): ?>
                            ...
                            <div>
                                ...
                                <small class="text-muted">
                                    <?= date('M j, g:i A', strtotime($booking['booking_date'])) ?>
                                </small>
                            </div>
                        </div>
                    </div>
